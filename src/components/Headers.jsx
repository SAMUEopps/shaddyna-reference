          ...
          <div className="h-[80px] md-lg:h-[100px] flex justify-between items-center flex-wrap">
            <div className="md-lg:w-full w-3/12 md-lg:pt-4">
              <div className="flex justify-between items-center">
                ...
                <div
                    className="flex justify-center items-center w-[40px] h-[40px] bg-gray-200 text-black border-2 border-gray-200 rounded-full cursor-pointer lg:hidden md-lg:flex xl:hidden hidden"
                    onClick={() => setShowShidebar(false)}
                  >
                 <span>
                    <FaList className="text-black text-l" />
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="flex justify-between md-lg:justify-center items-center flex-wrap pl-8">
                <ul className="flex justify-start items-start gap-8 text-sm font-bold uppercase md-lg:hidden">
                  ...
                  <li>
                    ...
                    <div className="md:fixed md:bottom-0 md:left-0 md:right-0 md:bg-white md:shadow-lg md:flex md:justify-around md:items-center md:py-2 md:z-20">
  <div className="flex justify-center md:justify-between gap-5 w-full mx-4"> {/* Added mx-4 here */}
    <div
        ...
        <div className="flex w-full flex-wrap md-lg:gap-8">
          <div className="w-3/12 md-lg:w-full">
            ...
            <div
              ...
              className="h-[50px] bg-[#1a2253] text-white flex justify-center md-lg:justify-between md-lg:px-6 items-center gap-3 font-bold text-md cursor-pointer rounded-lg"
            >
          ...
          <div className="w-9/12 pl-8 md-lg:pl-0 md-lg:w-full">
            <div className="flex flex-wrap w-full justify-between items-center md-lg:gap-6">
              ...
              <div className="flex border-0 h-[50px] bg-white items-center relative gap-5 rounded-md shadow-custom">
                  ...
                  <input
                    className="w-full bg-white text-black outline-0 px-3 pr-10 h-full border-0"
                  ...
                  <button
                    ...
                    >
                      <FiSearch className="mr-2 text-slate-300" size={20} />
                  </button>
                  </div>
                  <div
                    className="bg-slate-100 absolute top-[48px] z-10 left-0 max-h-[350px] overflow-y-auto w-full"
                    style={{
                      scrollbarWidth: "thin",
